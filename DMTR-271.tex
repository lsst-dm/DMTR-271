...
\begin{tabular}{p{2cm}p{14cm}}
\toprule
Step 1 & Step Execution Status: \textbf{ In Progress } \\ \hline
\end{tabular}
 Description \\
{\footnotesize
...
test.\\[3\baselineskip]Requirements that have not yet been verified:\\
LVV-19742: DMS-MWST-REQ-0013-V-01: I/O via Butler -- This one seems to
be about design. Could it be demonstrated by showing code snippets +
explanation?\\
LVV-19750: DMS-MWST-REQ-0014-V-01: Butler dataset type configuration --
I don't see specific examples of this in either DRP.yaml within
ci\_hsc\_gen3, or DRP-RC2.yaml in drp\_pipe. There are examples in faro
pipelines?\\
LVV-19850: DMS-MWST-REQ-0006-V-01: Dataset grouping -- This specifies
that the pipeline shall designate how datasets should be grouped. Isn't
this done via Connections rather than in the Pipelines?\\
LVV-19859: DMS-MWST-REQ-0007-V-01: Changes of parallelization -- By
stating that steps in a pipeline can have different dataset grouping, is
this simply referring to the fact that the Connections (and thus the
quantum dimensions) can be different for each step?\\
LVV-19796: DMS-MWST-REQ-0011-V-01: Phases of execution -- Is it
sufficient for the DAG to be generated during ci\_hsc\_gen3 but not
persisted, or should this be demonstrated by persisting a quantum graph
and then separately reading it in to do the processing?\\
LVV-19809: DMS-MWST-REQ-0012-V-01: Implied inputs -- What does it mean
to ``support resolution of full DataId specifications for ``implied
inputs''"?\\
LVV-19864: DMS-MWST-REQ-0017-V-01: Pipeline specification definition --
I simply don't understand what this one means.\\
LVV-19861: DMS-MWST-REQ-0010-V-01: Executable by supervisory framework
-- Also not sure how to interpret this one.\\[2\baselineskip]
