...
Make and attach a quantum graph that illustrates
this?\\[2\baselineskip]Requirements that have not yet been verified:\\
-- By stating that steps in a pipeline can have different dataset
grouping, is this simply referring to the fact that the Connections (and
thus the quantum dimensions) can be different for each step?\\
